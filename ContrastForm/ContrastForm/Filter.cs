    ...
    public class Filter
    {
        ...
        public Filter(Bitmap MainBitmap)
        {
            if (MainBitmap != null)
            {
                ...
                BmpData = UPicture.LockBits(new Rectangle(0, 0, UPicture.Width, UPicture.Height), ImageLockMode.ReadWrite, UPicture.PixelFormat);
                unsafe
                {
        ...
        public Bitmap Picture { get { return UPicture; } }
        public int Height { get { return UPicture.Height; } }
        public int Width { get { return UPicture.Width; } }
